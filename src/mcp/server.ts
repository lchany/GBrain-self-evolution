...
import { GBRAIN_SERVER_CAPABILITIES, GBRAIN_SERVER_INSTRUCTIONS, registerDiscoveryHandlers } from './discovery.ts';
...
export async function startMcpServer(engine: BrainEngine, opts: { surface?: McpSurface; sourceGuard?: boolean } = {}) {
  const server = new Server(
    ...
    { capabilities: GBRAIN_SERVER_CAPABILITIES, instructions: GBRAIN_SERVER_INSTRUCTIONS },
  );
